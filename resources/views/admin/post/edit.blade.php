                              ...
                              <div class="row">
                                        ...
                                        <div class="row align-center">
                                          ...
                                          <div class="col-4">
                                            <div style="max-width: 100px;max-height:100px;overflow:hidden;margin-left:auto">
                                              <img src="{{ asset('public/storage/post/'.$post->image) }}" class="img-fluid" alt="">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="description" id="summernote" rows="3" placeholder="Enter description" style="height: 73px;">
                                          {{ $post->description }}
                                        </textarea>
                                      </div>
                                </div>
